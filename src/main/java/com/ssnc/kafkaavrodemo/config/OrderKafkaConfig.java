...
/**
 * Kafka configuration for Order producer and consumer.
 * Uses String keys and Avro values.
 */
@Configuration
public class OrderKafkaConfig {
    ...
    @Value("${spring.kafka.order.producer.key-serializer}")
    private String keySerializer;

    @Value("${spring.kafka.order.producer.value-serializer}")
    private String valueSerializer;

    @Value("${spring.kafka.order.consumer.group-id}")
    private String consumerGroupId;

    @Value("${spring.kafka.order.consumer.key-deserializer}")
    private String keyDeserializer;

    @Value("${spring.kafka.order.consumer.value-deserializer}")
    private String valueDeserializer;

    @Value("${spring.kafka.order.consumer.auto-offset-reset}")
    private String autoOffsetReset;

    @Value("${spring.kafka.order.consumer.specific-avro-reader}")
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderDetails> orderKafkaListenerContainerFactory() {
